...
public class FoodPageFlavorFilterReadStrategy implements FoodPageReadStrategy {
    private final FoodRepository foodRepository;

    @Override
    public void setBeanName(String name) {
        if (!name.equals(FoodPageReadType.FLAVOR_READ.getKey())) {
            log.info("expected bean name={}, real bean name={}", FoodPageReadType.FLAVOR_READ.getKey(), name);
