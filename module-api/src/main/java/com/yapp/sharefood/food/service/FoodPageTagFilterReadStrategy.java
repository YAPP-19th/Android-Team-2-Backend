...
public class FoodPageTagFilterReadStrategy implements FoodPageReadStrategy {
    private final FoodRepository foodRepository;

    @Override
    public void setBeanName(String name) {
        if (!name.equals(FoodPageReadType.TAG_READ.getKey())) {
            log.info("expected bean name={}, real bean name={}", FoodPageReadType.TAG_READ.getKey(), name);
