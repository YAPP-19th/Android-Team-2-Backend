...
import static com.yapp.sharefood.common.documentation.DocumentationUtils.getDocumentRequest;
import static com.yapp.sharefood.common.documentation.DocumentationUtils.getDocumentResponse;
...
public class DocumentRequestBuilder {
    ...
    public static class MockMvcFunction {
        ...
        public <T> Options patch(String path, T body, Object... params) {
            return new Options(new PatchPerform<>(path, body, params));
        }

        public Options patchWithOutBody(String path, Object... params) {
            return new Options(new PatchPerform<>(path, params));
        }
    ...
    private static class PatchPerform<T> implements HttpMethodRequest {
        private final String path;
        private final T body;
        private final Object[] params;

        private PatchPerform(String path, Object[] params) {
            this(path, null, params);
        }

        private PatchPerform(String path, T body, Object[] params) {
            this.path = path;
            this.body = body;
            this.params = params;
        }
        ...
        @Override
        public MockHttpServletRequestBuilder doAction() throws JsonProcessingException {
            MockHttpServletRequestBuilder mockHttpServletRequestBuilder = patch(path, params)
                    .accept(MediaType.APPLICATION_JSON_VALUE)
                    .contentType(MediaType.APPLICATION_JSON_VALUE);
