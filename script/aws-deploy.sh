...
nohup java -jar $DEPLOY_JAR --spring.profiles.active=dev --spring.datasource.hikari.jdbc-url=jdbc:mysql://172.17.0.2:3306/dev?serverTimezone=UTC --spring.user.datasource.hikari.jdbc-url=jdbc:mysql://172.17.0.2:3306/dev?serverTimezone=UTC --spring.config.additional-location=/home/ec2-user/application-aws-dev.yml 2>&1 &
